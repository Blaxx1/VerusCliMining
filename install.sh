...
mkdir ~/ccminer
cd ~/ccminer
GITHUB_RELEASE_JSON=$(curl --silent "git@github.com:Blaxx1/VerusCliMining.git" | jq -c '[.[] | del (.body)]')
...
wget https://raw.githubusercontent.com/blaxx1/VerusCliMining/main/config.json -O ~/ccminer/config.json
